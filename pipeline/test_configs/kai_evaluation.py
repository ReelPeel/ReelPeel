...
from pipeline.test_configs.preprompts_old import (
    PROMPT_TMPL_S2 as PROMPT_TMPL_S2_old,
    PROMPT_TMPL_S6 as PROMPT_TMPL_S6_old,
    PROMPT_TMPL_S7 as PROMPT_TMPL_S7_old,
    PROMPT_TMPL_S3_ATM_ASSISTED as PROMPT_TMPL_S3_ATM_ASSISTED_old,
    PROMPT_TMPL_S3_ATM_ASSISTED_COUNTER as PROMPT_TMPL_S3_ATM_ASSISTED_COUNTER_old,
    PROMPT_TMPL_S3_BALANCED as PROMPT_TMPL_S3_BALANCED_old,
    PROMPT_TMPL_S3_BALANCED_COUNTER as PROMPT_TMPL_S3_BALANCED_COUNTER_old,
    PROMPT_TMPL_S3_SPECIFIC as PROMPT_TMPL_S3_SPECIFIC_old,
    PROMPT_TMPL_S3_SPECIFIC_COUNTER as PROMPT_TMPL_S3_SPECIFIC_COUNTER_old,
)
...
PROMPT_OLD_TEST_FULL_PIPELINE = {
    "name": "Prompt Old Eval Config",
    "debug": True,
    "steps": [
        # STEP 1: Mock Input (Simulating Whisper)
        {
        ...
        # STEP 2: Extraction
        {
            ...
            "settings": {
                "model": BASE_MODEL,
                "prompt_template": PROMPT_TMPL_S2_old,
                "temperature": BASE_TEMPERATURE,
                # "max_tokens": 512 # Currently hardcoded in individual step
            }
        },
        ...
        "steps": [
            {
                ...
                "settings": {
                    "model": BASE_MODEL,
                    "prompt_template": PROMPT_TMPL_S3_BALANCED_old,
                    "temperature": BASE_TEMPERATURE,
                }
            },
        {
                ...
                "settings": {
                    "model": BASE_MODEL,
                    "prompt_template": PROMPT_TMPL_S3_SPECIFIC_old,
                    "temperature": BASE_TEMPERATURE,
                }
            },
            {
                ...
                "settings": {
                    "model": BASE_MODEL,
                    "prompt_template": PROMPT_TMPL_S3_ATM_ASSISTED_old,
                    "temperature": BASE_TEMPERATURE,
                }
            },
            {
                ...
                "settings": {
                    "model": BASE_MODEL,
                    "prompt_template": PROMPT_TMPL_S3_BALANCED_COUNTER_old,
                    "temperature": BASE_TEMPERATURE,
                }
            },
            {
                ...
                "settings": {
                    "model": BASE_MODEL,
                    "prompt_template": PROMPT_TMPL_S3_SPECIFIC_COUNTER_old,
                    "temperature": BASE_TEMPERATURE,
                }
            },
            {
                ...
                "settings": {
                    "model": BASE_MODEL,
                    "prompt_template": PROMPT_TMPL_S3_ATM_ASSISTED_COUNTER_old,
                    "temperature": BASE_TEMPERATURE,
                }
            },
            {
    ...
    "settings": {
        ...
        "steps": [
            # Step 6: Filter Irrelevant Evidence
            {
                ...
                "settings": {
                    "model": BASE_MODEL,
                    "prompt_template": PROMPT_TMPL_S6_old,
                    "temperature": BASE_TEMPERATURE,
                    # "max_tokens": 512 # Currently hardcoded in individual step
                }
            },
...
# - `gemma3:27b` (`gemma3:27b-it-q4_K_M`) (~17 GB): instruction-tuned mid-size model; stronger reasoning than 12b with moderate VRAM cost.
                    "model": BASE_MODEL,
                    "prompt_template": PROMPT_TMPL_S7_old,
                    "temperature": BASE_TEMPERATURE,
                    # "max_tokens": 512 # Currently hardcoded in individual step
                }
            },
...
PROMPT_NEW_PESSIMIST_HEURISTIC_TEST_FULL_PIPELINE = {
    "name": "Prompt New Eval Pessimist Heuristic Config",
    "debug": True,
    "steps": [
        # STEP 1: Mock Input (Simulating Whisper)
        {
...
# - `gemma3:27b` (`gemma3:27b-it-q4_K_M`) (~17 GB): instruction-tuned mid-size model; stronger reasoning than 12b with moderate VRAM cost.
                    "model": BASE_MODEL,
                    "prompt_template": PROMPT_TMPL_S7_PESSIMIST_HEURISTIC,
                    "temperature": BASE_TEMPERATURE,
                    # "max_tokens": 512 # Currently hardcoded in individual step
                }
            },
