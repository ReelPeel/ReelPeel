...
############################################### WARNUNG #################################################
############################################### WARNUNG #################################################
#                                       EXTRACTION STEP 2 IST VORHANDEN
#                                        Könnte die Statements verändern
############################################### WARNUNG #################################################
############################################### WARNUNG #################################################
############################################### WARNUNG #################################################
...
PROMPT_NEW_MEDITRON_ASSYMETRIC_TEST_FULL_PIPELINE = {
    "name": "Prompt New Meditron Assymetric Eval Config",
    "debug": True,
    "steps": [
        # STEP 1: Mock Input (Simulating Whisper)
        {
...
# - `gemma3:27b` (`gemma3:27b-it-q4_K_M`) (~17 GB): instruction-tuned mid-size model; stronger reasoning than 12b with moderate VRAM cost.
                    "model": "hf.co/mradermacher/Meditron3-70B-GGUF:latest",
                    "prompt_template": PROMPT_TMPL_S7_ASYMMETRIC,
                    "temperature": BASE_TEMPERATURE,
                    # "max_tokens": 512 # Currently hardcoded in individual step
                }
            },
...
PROMPT_NEW_DEEPSEEK_TEST_FULL_PIPELINE = {
    "name": "Prompt New DeepSeek Eval Config",
    "debug": True,
    "steps": [
        # STEP 1: Mock Input (Simulating Whisper)
        {
...
# - `gemma3:12b` (`gemma3:12b-it-q4_K_M`) (~8.1 GB): instruction-tuned general model; fast and light, good for quick extraction/filtering.
# - `gemma3:27b` (`gemma3:27b-it-q4_K_M`) (~17 GB): instruction-tuned mid-size model; stronger reasoning than 12b with moderate VRAM cost.
                    "model": "hf.co/mradermacher/DeepSeek-R1-Distill-Qwen-32B-Medical-GGUF:Q8_0",
                    "prompt_template": PROMPT_TMPL_S7,
                    "temperature": BASE_TEMPERATURE,
                    # "max_tokens": 512 # Currently hardcoded in individual step
                }
...
PROMPT_NEW_MEDITRON_PHI_TEST_FULL_PIPELINE = {
    "name": "Prompt New Meditron Phi Eval Config",
    "debug": True,
    "steps": [
        # STEP 1: Mock Input (Simulating Whisper)
        {
...
# - `gemma3:12b` (`gemma3:12b-it-q4_K_M`) (~8.1 GB): instruction-tuned general model; fast and light, good for quick extraction/filtering.
# - `gemma3:27b` (`gemma3:27b-it-q4_K_M`) (~17 GB): instruction-tuned mid-size model; stronger reasoning than 12b with moderate VRAM cost.
                    "model": "hf.co/mradermacher/Meditron3-Phi4-14B-i1-GGUF:Meditron3-Phi4-14B.i1-Q4_K_M.gguf",
                    "prompt_template": PROMPT_TMPL_S7,
                    "temperature": BASE_TEMPERATURE,
                    # "max_tokens": 512 # Currently hardcoded in individual step
                }
